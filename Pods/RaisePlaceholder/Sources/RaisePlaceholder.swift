...
public class RaisePlaceholder: UITextField, UITextFieldDelegate {
    ...
    fileprivate let placeholderLabelFontSize: CGFloat = 13.0
    ...
    fileprivate func createPlaceholderLabel() {
        ...
        let label = UILabel(frame: CGRect(x: origin.x, y: origin.y+5, width: self.frame.size.width, height: 12.0))
    ...
    public func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if let placeholderLabel = self.placeholderLabel, self.text == "" {
            ...
            UIView.animate(withDuration: animationDuration, animations: {
                ...
                placeholderLabel.frame.origin.y = frame.origin.y - placeholderLabel.frame.size.height - (self.frame.size.height / 2 - frame.size.height / 2) + 10
