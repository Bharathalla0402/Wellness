...
class TermsViewController: UIViewController,UIWebViewDelegate,SecondDelegate {
    ...
    override func viewDidLoad() {
        ...
        TermswebView.backgroundColor = UIColor.white
        ...
        // TermswebView.isUserInteractionEnabled = false
